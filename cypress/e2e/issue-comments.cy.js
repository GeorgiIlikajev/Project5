describe('Issue comments creating, editing, and deleting', () => {
    ...
    it('Should edit a comment successfully', () => {
      ...
      getIssueDetailsModal().within(() => {
        ...
        cy.get('textarea[placeholder="Add a comment..."]').should('contain', previousComment).clear().type(comment_edited);
        cy.contains('button', 'Save').click().should('not.exist');
        cy.get('[data-testid="issue-comment"]').should('contain', 'Edit').and('contain', comment_edited);
      });
    });
